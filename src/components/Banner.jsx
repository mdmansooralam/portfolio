            ...
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-start">
                <div className='w-full lg:w-[60%] shrink-0 py-2.5 text-center md:text-left'>
                    ...
                    <p className='mb-12 text-center lg:text-start'>
                      I am a dedicated software developer with hands-on experience in building full-stack web application using the MERN stack. My focus lies in developing practical, scalable solutions with real-time functionality, third-party integrations, and clean, maintainable code. I am committed to continuous learning and delivering impactful digital experience.  
                    </p>
                    ...
                    <div className='flex gap-1 justify-center lg:justify-start'>
                        ...
                        <a href='#' aria-label='LinkedIn link' className='p-1.5'><ImLinkedin2 size={24}/></a>
