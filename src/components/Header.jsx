                ...
                <div className="container flex justify-between items-center flex-wrap">
                    ...
                    <div className={`basis-full lg:basis-auto max-h-0 lg:max-h-screen overflow-hidden ${collapse ? '' : 'max-h-screen'} flex-col lg:flex-row lg:items-center flex transition-all duration-500`}>
                        ...
                        <div className="py-4 lg:py-0 flex flex-col lg:flex-row gap-4 lg:items-center lg:ml-12 w-full lg:w-auto">
                            <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')} className="cursor-pointer flex justify-between text-l-gray-600  dark:text-d-gray-600 "><span className="lg:hidden">Switch Theme</span>
                                <span className="hover:rotate-45 transition-all duration-500">{
                                    theme === 'dark' ?
                            ...
                            <Link to={'https://res.cloudinary.com/dw0ktpdca/image/upload/v1750165039/Resume-Mansoor_rktscx.pdf'} target="_blank" className='cursor-pointer bg-gray-900 dark:bg-d-gray-900 text-l-gray-50 dark:text-d-gray-50 py-1.5 px-4 w-full block rounded-xl  font-medium'>Download CV</Link>
                        </div>
